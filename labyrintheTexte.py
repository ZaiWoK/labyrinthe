...
def afficheLabyrinthe(lmt,message="",sauts=0):
    ...
    for i in range(1,7,2):
        print(" "+str(i),sep='',end='')
    print()
    for i in range(getNbLignes(plateau["plateau"]["matrice"])):
        print(remplissage,end='')            
        if i%2==0:
            print(' ',sep='',end='')
        else:
            print(str(i),sep='',end='')
        for j in range(getNbColonnes(plateau["plateau"]["matrice"])):
            afficheCarte(lmt,getVal(plateau["plateau"]["matrice"],i,j),numJoueurCourant(listeJoueurs),tresor)
        if i%2==0:
            print(' ',sep='',end='')
        else:
            print(str(i),sep='',end='')            
...
def saisirOrdre(lmt):
    ...
    """
    x=(input("Veuillez saisir un ordre"))
    if x=='N' or x=='E' or x=='S' or x=='O':
        y=int(input("Veuillez choisir la rangée"))
...
def saisirDeplacement(lmt):
    ...
    """    
    lin=int(input("Veuillez saisir le numéro de ligne"))
    col=int(input("Veuillez saisir le numéro de la colonne"))
    if lin<=6 and col<=6:
        return (lin,col)
    else:
        return (-1,-1)
